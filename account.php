...
<div class="row">
<div class="col-lg-6">
<span class="logo">Manipal Quizzes</span></div>
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by XYZ</a>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">vibhav infotech</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9514444471</h4>
		<h4 style="font-family:'typo' ">vibhavsrivastava8@gmail.com</h4>
		<h4 style="font-family:'typo' ">Manipal Instute of Technology ,Erode </h4></div></div>
		</p>
      </div>
